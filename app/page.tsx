...
import { Github, Linkedin, Twitter, Mail, MapPin, Facebook, Instagram, Code, Award, Target } from "lucide-react"
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="relative floating-animation">
                <div className="glass-card p-4 sm:p-6 max-w-sm sm:max-w-md">
                  <Image
